...
export const ARTICLES = [
  {
    ...
    description:
      'Cómo atribuir a Meta Ads una venta cerrada en WhatsApp: captura del ctwa_clid, envío por API de Conversiones y verificación de la calidad de coincidencia.',
    standfirst:
    ...
    hook: 'El recorrido completo del dato, y los cuatro puntos donde se rompe.',
    forWhom: 'Empieza aquí si no tienes nada montado. Las otras cuatro desarrollan una pieza de este recorrido.',
  ...
  },
  {
    ...
    description:
      'Qué es la API de Conversiones de Meta (CAPI): envío servidor a servidor, hasheo de user_data, deduplicación por event_id y los tres problemas que no resuelve.',
    standfirst:
    ...
    hook: 'No es "el Pixel pero en el servidor". Es otro canal, con otras reglas.',
    forWhom: 'Requisito previo de las dos siguientes. Léela si nunca has enviado un evento de servidor a Meta.',
    published: '2026-07-24',
    lastmod: '2026-07-24',
    related: [
      'alimentar-pixel-meta-desde-whatsapp',
  ...
  },
  {
    ...
    description:
      'No se instala un pixel dentro de WhatsApp: se escribe en el dataset del Pixel desde tu servidor. Payload, deduplicación y calidad de coincidencia, paso a paso.',
    standfirst:
    ...
    hook: 'La pregunta está mal planteada. Esta es la que sí tiene respuesta.',
    forWhom: 'La guía de implementación. Da por sabido qué es CAPI; si no lo tienes claro, lee antes la anterior.',
    published: '2026-07-24',
    lastmod: '2026-07-24',
    related: [
      'api-de-conversiones-meta-que-es',
  ...
  },
  {
    ...
    description:
      'Qué hace falta para que el ROAS de WhatsApp sea real y no estimado: valor y moneda de conversión, ventana de atribución, desfase de reporte e incrementalidad.',
    standfirst:
    ...
    hook: 'Cuatro decisiones que se toman antes de enviar el primer evento.',
    forWhom: 'Para cuando la señal ya llega y toca defender el número ante dirección o ante finanzas.',
    published: '2026-07-24',
    lastmod: '2026-07-24',
    related: [
      'como-trackear-ventas-whatsapp-meta-ads',
  ...
  },
  {
    ...
    description:
      'Por qué los UTMs no sobreviven al salto a WhatsApp, y comparativa de cinco métodos incluido el reporte nativo de Meta y la atribución por CAPI con ctwa_clid.',
    standfirst:
    ...
    hook: 'No están rotos: están fuera de jurisdicción.',
    forWhom: 'Léela antes de montar nada: puede que el reporte nativo de Meta ya te baste y te ahorre el resto.',
    published: '2026-07-24',
    lastmod: '2026-07-25',
    related: [
      'como-trackear-ventas-whatsapp-meta-ads',
